...
Deno.serve(async (req) => {
  try {
    ...
    const html = `
      <h2 style="font-family:sans-serif;">New Training Inquiry</h2>
      <table style="border-collapse:collapse;width:100%;font-family:sans-serif;max-width:600px;">
        ...
        <tr><td style="padding:8px 12px;font-weight:bold;background:#f3f4f6;border:1px solid #e5e7eb;">Team size</td><td style="padding:8px 12px;border:1px solid #e5e7eb;">${inquiry.team_size || 'N/A'}</td></tr>
        <tr><td style="padding:8px 12px;font-weight:bold;background:#f3f4f6;border:1px solid #e5e7eb;">Platform</td><td style="padding:8px 12px;border:1px solid #e5e7eb;">${inquiry.platform || 'N/A'}</td></tr>
        ...
        <tr><td style="padding:8px 12px;font-weight:bold;background:#f3f4f6;border:1px solid #e5e7eb;">Timeline</td><td style="padding:8px 12px;border:1px solid #e5e7eb;">${inquiry.timeline || 'N/A'}</td></tr>
    ...
    const subject = `New Training Inquiry: ${inquiry.name}${inquiry.organization ? ' (' + inquiry.organization + ')' : ''}`;

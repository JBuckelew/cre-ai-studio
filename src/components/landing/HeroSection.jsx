            ...
            <div className="relative max-w-xl">
              <div className="relative">
                ...
                <div className="inline-flex items-center mb-6">
                  <div className="w-1.5 h-12 bg-gradient-to-b from-blue-400 via-purple-400 to-pink-400 rounded-full mr-6"></div>
                  <div className="flex items-center gap-3">
                    <img src="https://qtrypzzcjebvfcihiynt.supabase.co/storage/v1/object/public/base44-prod/public/68a7d83d574299e5af5ccbd3/08b784b52_background_removalTUFHX0U1djZvcTAjMSM2Y2FmMjhhNTNhMzRiYzBiNTFlMTQ3ZGQxNmEyZTRmMCMxMDI0IyNUUkFOU0ZPUk1BVElPTl9SRVFVRVNU.png" alt="CRE AI Studio" className="h-48 object-contain" />

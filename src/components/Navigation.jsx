      ...
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="hidden md:grid md:grid-cols-3 items-center h-16">
          ...
          <div className="justify-self-start">
            <h1 className="text-2xl font-bold bg-gradient-to-r from-blue-900 to-blue-500 bg-clip-text text-transparent">
              CRE AI Studio
            </h1>
          </div>
        ...
        <div className="md:hidden py-2">
          ...
          <div className="flex items-center justify-center mb-2">
            <h1 className="text-xl font-bold bg-gradient-to-r from-blue-900 to-blue-500 bg-clip-text text-transparent">
              CRE AI Studio
            </h1>
          </div>

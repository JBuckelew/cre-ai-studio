      ...
      <div className="relative max-w-7xl mx-auto px-6">
        ...
        >
          ...
          <p className="text-lg md:text-xl text-slate-600 max-w-4xl mx-auto leading-relaxed">
            Whether you're a broker marketing your business, an investor sourcing & analyzing deals, an asset manager or developer managing complex projects, or an attorney navigating complex transactions, 

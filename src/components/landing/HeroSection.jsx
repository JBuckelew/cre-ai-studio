          ...
          <div className="flex-1 flex items-center justify-start w-full">
            ...
            <div className="relative max-w-xl">
              <div className="relative">
                ...
                >
                  <div className="w-1 h-12 bg-gradient-to-b from-blue-500 via-purple-500 to-pink-500 rounded-full mr-4"></div>
                  <div className="flex flex-wrap items-center gap-2">
                    <img src="https://qtrypzzcjebvfcihiynt.supabase.co/storage/v1/object/public/base44-prod/public/68a7d83d574299e5af5ccbd3/c1f3820e0_background_removalTUFHX0U1djZvcTAjMSM2Y2FmMjhhNTNhMzRiYzBiNTFlMTQ3ZGQxNmEyZTRmMCMxMDI0IyNUUkFOU0ZPUk1BVElPTl9SRVFVRVNU.png" alt="CRE AI Studio" className="h-8 object-contain" />
                    <span className="text-slate-300 text-sm font-medium">and</span>
                    <img src="https://qtrypzzcjebvfcihiynt.supabase.co/storage/v1/object/public/base44-prod/public/68a7d83d574299e5af5ccbd3/f61f154d1_cre-daily-logo.png" alt="CRE Daily" className="h-6 object-contain" />
                    <span className="text-slate-300 text-sm font-medium">Partnered Together to Take the CRE Industry into the Future</span>
                  </div>
                </motion.div>
